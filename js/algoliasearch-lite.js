...
!(function (e, t) {
    ...
    function q(e, t) {
        return Promise.all(
            ...
            var r = e.filter(function (e) {
                    return (function (e) {
                        return (
                            e.status === p || Date.now() - e.lastUpdate > 12e4
                        );
                    })(e);
                }),
    ...
    function j(e, t, n, o) {
        var u = [],
            i = (function (e, t) {
                if (e.method === O || (void 0 === e.data && void 0 === t.data))
                    return;
            ...
            a = {
                ...
                logger:
                    ((o = H),
                    {
                        debug: function (e, t) {
                            return (
                                D >= o && console.debug(e, t), Promise.resolve()
                            );
                        },
                        info: function (e, t) {
                            return (
                                W >= o && console.info(e, t), Promise.resolve()
                            );
                        },
                        error: function (e, t) {
