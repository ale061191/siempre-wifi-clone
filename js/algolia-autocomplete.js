...
!(function (e, t) {
        ...
        return {
            ...
            clickedObjectIDsAfterSearch: function () {
                for (
                    ...
                    t[n] = arguments[n];
                t.length > 0 &&
                    i("clickedObjectIDsAfterSearch", B(t), t[0].items);
            },
            ...
            convertedObjectIDsAfterSearch: function () {
                for (
                    ...
                    t[n] = arguments[n];
                t.length > 0 &&
                    i("convertedObjectIDsAfterSearch", B(t), t[0].items);
            },
    ...
    function J() {
        ...
        return [].concat(
            ...
            M(
                null !== (e = n.algoliaInsightsPlugin) &&
                    void 0 !== e &&
                    ...
                    return Promise.all(
                        []
                            ...
                            .map(function (e) {
                                return (function (e, t) {
                                    var n = [];
                                    return Promise.resolve(e(t)).then(function (
                                        e
                                    ) {
                                        return Promise.all(
                                            e
    ...
    function ze(e) {
        ...
        var h = Y(
            $e(
                o
                    .getSources(
                        Ue({ query: i, refresh: u, state: a.getState() }, l)
                    )
                    .then(function (e) {
                        return Promise.all(
                            e.map(function (e) {
    ...
    function pt(e) {
        ...
        return {
            ...
            getLabelProps: function (e) {
                return ct(
                    { htmlFor: ue(t.id, "input"), id: ue(t.id, "label") },
                    e
                );
            },
                            ...
                            !(function (e) {
                                ...
                                if (
                                    ...
                                    var u = function () {
                                            var e = ie(o.getState()),
                                                t =
                                                    n.environment.document.getElementById(
                                                        ue(
                                                            n.id,
                                                            "item-".concat(
                                                                o.getState()
    ...
    function bt(e) {
        var t,
            ...
            a =
                null ===
                    (t = ((null === (n = u.__autocomplete_metadata) ||
                    void 0 === n
                        ? void 0
            ...
            l = a
                ? yt(
                      ...
                      a,
                      Object.keys(
                          (null === (r = u.__autocomplete_metadata) ||
                          void 0 === r
                              ? void 0
                              : r.options) || {}
                      )
        ...
        switch (t.type) {
            ...
            case "setContext":
                return Ot(
                    Ot({}, e),
                    {},
                    { context: Ot(Ot({}, e.context), t.payload) }
                );
            case "ArrowDown":
                var n = Ot(
                    Ot({}, e),
    ...
    function Et(e) {
        var t = [],
            ...
            i = pt(
                It(
                    { props: n, refresh: u, store: r, navigator: n.navigator },
                    o
                )
            );
        function u() {
        ...
        return (
            ...
            (function (e) {
                ...
                metadata: bt({ plugins: n.plugins, options: e }),
        ...
        if ("style" === t)
            ...
            "o" === t[0] && "n" === t[1]
                ? ((r = t !== (t = t.replace(/Capture$/, ""))),
                  ...
                  (e._listeners[t] = n),
                  n
                      ? i || e.addEventListener(t, Ut, r)
                      : e.removeEventListener(t, Ut, r))
                : "list" !== t &&
                  "tagName" !== t &&
                  "form" !== t &&
                  "type" !== t &&
    ...
    function sn(e, t, n) {
        ...
        if (
            (arguments.length > 2 &&
                (u.children = arguments.length > 3 ? Xt.call(arguments, 2) : n),
    ...
    function yn(e) {
        ((!e.__d && (e.__d = !0) && en.push(e) && !bn.__r++) ||
            tn !== Yt.debounceRendering) &&
    ...
    function jn(e, t, n, r, o) {
        ...
        e: if ("style" === t)
            if ("string" == typeof n) e.style.cssText = n;
                ...
                if (n)
                    for (t in n) (r && n[t] === r[t]) || Sn(e.style, t, n[t]);
            }
        else if ("o" === t[0] && "n" === t[1])
            (i = t !== (t = t.replace(/Capture$/, ""))),
                ...
                (e.l[t + i] = n),
                n
                    ? r || e.addEventListener(t, i ? wn : Pn, i)
                    : e.removeEventListener(t, i ? wn : Pn, i);
            ...
            e: if ("function" == typeof P) {
                if (
                    ...
                    null != P.getDerivedStateFromProps &&
                        (s.__s == s.state && (s.__s = ln({}, s.__s)),
                        ln(s.__s, P.getDerivedStateFromProps(y, s.__s))),
                    (p = s.props),
                    (m = s.state),
                    (s.__v = t),
                    f)
                    ...
                    null != s.componentWillUpdate &&
                        s.componentWillUpdate(y, s.__s, g),
    ...
    function Cn(e, t, n) {
        ...
        if ((r = e.__k))
            for (o = 0; o < r.length; o++)
                r[o] && Cn(r[o], t, n || "function" != typeof e.type);
    ...
    function Rn(e) {
        ...
        return (
            "string" != typeof o && (o = y(t, r) || ""),
            Tn({ highlightedValue: o })
        );
    }
    var Fn = {
            "&amp;": "&",
    ...
    function sr(e) {
        ...
        function r(e) {
            ...
            return t(
                n,
                {},
                ((r = { hit: o, attribute: i }), $n(Rn(r))).map(function (
                    e,
                    n
                ) {
                    return e.isHighlighted
    ...
    function fr(e) {
        ...
        function r(e) {
            ...
            return t(
                n,
                {},
                ((r = { hit: o, attribute: i }), $n(Jn(r))).map(function (
                    e,
                    n
                ) {
                    return e.isHighlighted
    ...
    (e.autocomplete = function (e) {
        var t,
            ...
            O = m(function () {
                return _.value.core.environment.matchMedia(
                    _.value.renderer.detachedMediaQuery
                ).matches;
            }),
            S = m(function () {
                return Et(
                    n(
                        ...
                        {},
                        {
                            onStateChange: function (e) {
                                var t, n, r;
                                (y.current = e.state.collections.some(function (
                                    e
                                ) {
                            ...
                            shouldPanelOpen:
                                ...
                                function (e) {
                                    ...
                                    if (O.value) return !0;
                                    var n = b(t) > 0;
                                    if (!_.value.core.openOnFocus && !t.query)
                                        return n;
                                    var r = Boolean(
                                        y.current ||
                                            _.value.renderer.renderNoResults
                                    );
                                    return (!n && r) || n;
                                },
        ...
        function D(e) {
            ...
            var t = {
                    ...
                    html: I.value,
                    dom: A.value,
                    panelContainer: O.value
                        ? A.value.detachedContainer
                        : _.value.renderer.panelContainer,
                    propGetters: P,
                    state: j.current,
                    renderer: _.value.renderer.renderer,
                },
                r =
                    (!b(e) && !y.current && _.value.renderer.renderNoResults) ||
                    _.value.renderer.render;
            !(function (e) {
                var t = e.autocomplete,
                    r = e.autocompleteScopeApi,
                    o = e.dom,
                ...
                Wt(
                    o.root,
                    i.getRootProps(
                        n({ state: u, props: t.getRootProps({}) }, r)
                    )
                ),
                    Wt(
                        o.input,
                    ...
                    Vt(o.detachedSearchButtonPlaceholder, {
                        hidden: Boolean(u.query),
                    });
            })(t),
                (function (e, t) {
                        ...
                        var v = f.collections
                                .filter(function (e) {
                                    var t = e.source,
                                        n = e.items;
                                    return (
                                        t.templates.noResults || n.length > 0
                                    );
                                })
                                .map(function (e, t) {
                                    var l = e.source,
                            ...
                            y = v.reduce(function (e, t) {
                                return (
                                    (e[t.props["data-autocomplete-source-id"]] =
                                        t),
                                    e
                                );
                            }, {});
        ...
        function k(e) {
            requestAnimationFrame(function () {
                var t = _.value.core.environment.document.body.contains(
                    A.value.detachedOverlay
                );
                e !== t &&
                    (e
                        ? (_.value.core.environment.document.body.appendChild(
                              A.value.detachedOverlay
                          ),
                          _.value.core.environment.document.body.classList.add(
                              "aa-Detached"
                          ),
                          A.value.input.focus())
                        : (_.value.core.environment.document.body.removeChild(
                              A.value.detachedOverlay
                          ),
                          _.value.core.environment.document.body.classList.remove(
                              "aa-Detached"
                          )));
            });
        }
        return (
            ...
            a(function () {
                var e = O.value
                        ? _.value.core.environment.document.body
                        : _.value.renderer.panelContainer,
            ...
            a(function () {
                ...
                return (
                    (h.current = function (t) {
                        ...
                        n.query !== r.query) &&
                            _.value.core.environment.document
            ...
            a(function () {
                var e = p(function () {
                    var e = O.value;
                    (O.value = _.value.core.environment.matchMedia(
                        _.value.renderer.detachedMediaQuery
                    ).matches),
                ...
                return (
                    ...
                    function () {
                        _.value.core.environment.removeEventListener(
                            "resize",
                            e
                        );
                    }
            ...
            a(function () {
                ...
                var n = _.value.core.environment.matchMedia(
                    getComputedStyle(
                        _.value.core.environment.document.documentElement
